...
<template>
  <Card>
    <CardHeader>
      ...
      <CardDescription>
        Vos codes de récupération vous permettent de regagner l'accès si vous perdez votre appareil 2FA. Stockez-les
      ...
      <div class="flex flex-col gap-3 select-none sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          <component
            ...
            class="size-4"
          />
          {{ isRecoveryCodesVisible ? 'Cacher' : 'Afficher' }} les codes de récupération
        </Button>
      ...
      >
        <div class="mt-3 space-y-3">
          ...
          <p class="text-xs text-muted-foreground select-none">
            Chaque code de récupération peut être utilisé une seule fois pour accéder à votre compte et sera supprimé
            après utilisation. Si vous en avez besoin de plus, cliquez
